  ...
  users: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        EatDinner: { dataType: "boolean", required: true },
        EatLunch: { dataType: "boolean", required: true },
        EatBreakfast: { dataType: "boolean", required: true },
        HealthStatus: {
          dataType: "union",
          subSchemas: [
            { ref: "Prisma.JsonValue" },
        ...
        IsMale: { dataType: "boolean", required: true },
        StayIdentity: {
          dataType: "union",
          subSchemas: [
            { dataType: "double" },
        ...
        IsMonk: { dataType: "boolean", required: true },
        Email: {
          dataType: "union",
          subSchemas: [
            { dataType: "string" },
  ...
  rooms: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        ReservedBeds: { dataType: "double", required: true },
        TotalBeds: { dataType: "double", required: true },
        IsMale: { dataType: "boolean", required: true },
        RoomType: { dataType: "double", required: true },
        ShareId: { dataType: "double", required: true },
        BuildingId: { dataType: "double", required: true },
        DormitoryAreaId: { dataType: "double", required: true },
        Id: { dataType: "double", required: true }
      },
      validators: {}
    }
...
>>>>>>> d0deead (chore: 🤖 新增 onchange 讓 tsoa 可以自動生成 specs and routes)
        }
      };
      ...
      try {
        ...
        const promise = controller.getGuest.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, 200, next);
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  app.post(
    "/api/managers/generate",
    ...fetchMiddlewares<RequestHandler>(ManagersController),
    ...fetchMiddlewares<RequestHandler>(ManagersController.prototype.generate),

    function ManagersController_generate(
      request: any,
      response: any,
      next: any
    ) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(
      ManagersController.prototype.checkAuthorization
    ),

    function ManagersController_checkAuthorization(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.checkAuthorization.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, 200, next);
